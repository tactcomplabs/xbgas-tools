...
disassembler_t::disassembler_t(int xlen)
{
  ...
  DISASM_INSN("eaddi", eaddi, 0, {&xrd, &ers1, &imm});
  DISASM_INSN("eaddie", eaddie, 0, {&erd, &xrs1, &imm});
  DISASM_INSN("eaddix", eaddix, 0, {&erd, &ers1, &imm});
  
  // DEFINE_XAMO(eamoadd_w)
  // DEFINE_XAMO(eamoswap_w)
  // DEFINE_XAMO(eamoand_w)
  // DEFINE_XAMO(eamoor_w)
  // DEFINE_XAMO(eamoxor_w)
  // DEFINE_XAMO(eamomin_w)
  // DEFINE_XAMO(eamomax_w)
  // DEFINE_XAMO(eamominu_w)
  // DEFINE_XAMO(eamomaxu_w)
  // DEFINE_XAMO(eamoadd_d)
  // DEFINE_XAMO(eamoswap_d)
  // DEFINE_XAMO(eamoand_d)
  // DEFINE_XAMO(eamoor_d)
  // DEFINE_XAMO(eamoxor_d)
  // DEFINE_XAMO(eamomin_d)
  // DEFINE_XAMO(eamomax_d)
  // DEFINE_XAMO(eamominu_d)
  // DEFINE_XAMO(eamomaxu_d)
