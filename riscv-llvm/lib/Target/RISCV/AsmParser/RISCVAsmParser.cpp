...
public:
  ...
  bool isER64() const { return isReg(ER64Reg); }
};
...
static const unsigned ER64Regs[] = {
  RISCV::e0,  RISCV::e1,  RISCV::e2,  RISCV::e3, RISCV::e4,  RISCV::e5,  RISCV::e6,
  RISCV::e7,  RISCV::e8,  RISCV::e9,  RISCV::e10,RISCV::e11, RISCV::e12, RISCV::e13,
  RISCV::e14, RISCV::e15, RISCV::e16, RISCV::e17,RISCV::e18, RISCV::e19, RISCV::e20,
  RISCV::e21, RISCV::e22, RISCV::e23, RISCV::e24,RISCV::e25, RISCV::e26, RISCV::e27,
...
public:
  ...
  OperandMatchResultTy parseER64(OperandVector &Operands) {
    //return parseRegister(Operands, 'o', PR64Regs, RISCVOperand::PR64Reg);
    const AsmToken &Tok = Parser.getTok();
    if(Tok.is(AsmToken::Identifier)) {
      std::unique_ptr<RISCVOperand> op; 
      SMLoc S = Tok.getLoc();
      if( Tok.getIdentifier().equals_lower("e0") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e0,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e1") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e1,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e2") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e2,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e3") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e3,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e4") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e4,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e5") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e5,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e6") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e6,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e7") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e7,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e8") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e8,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e9") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e9,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e10") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e10,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e11") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e11,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e12") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e12,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e13") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e13,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e14") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e14,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e15") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e15,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e16") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e16,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e17") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e17,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e18") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e18,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e19") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e19,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e20") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e20,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e21") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e21,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e22") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e22,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e23") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e23,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e24") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e24,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e25") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e25,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e26") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e26,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e27") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e27,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e28") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e28,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e29") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e29,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e30") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e30,S,Tok.getLoc());
      }else if( Tok.getIdentifier().equals_lower("e31") ){
        op = RISCVOperand::createReg(RISCVOperand::ER64Reg,RISCV::e31,S,Tok.getLoc());
      }else{
...
bool RISCVAsmParser::ParseRegister(unsigned &RegNo, SMLoc &StartLoc,
  ...
  else if (Reg.Prefix == 'e' && Reg.Number <= 32)
    RegNo = ER64Regs[Reg.Number];
  else
